...
import {GoodscountShow} from '../../api/baobiaofenxi/wdshtj.js'
...
export default {
    ...
    return {
      ...
      column: {
        columnProps: [
          ...
          { props: 'Order_Billnet', label: '开票网点', computed: false },
  ...
  methods: {
    ...
    async show () {
      let gcs = await GoodscountShow({currentPage: this.currentPage, Order_Billnet: this.nodeData, pageCount: this.pageCount, searchData: this.momo.model})
